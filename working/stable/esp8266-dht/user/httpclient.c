...
void http_callback_tostdout(char * response, int http_status, char * full_response)
{
    os_printf("http_client: http_status=%d\n", http_status);
    os_printf("http_client: strlen(response)=%d\n", strlen(response));
    os_printf("http_client: strlen(full_response)=%d\n", strlen(full_response));
    os_printf("http_client: response=%s\n(end)\n", response);
}
